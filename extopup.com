...
<body>
    ...
    <script>
        ...
        function showRewardedAd() {
            window.open("https://www.profitablecpmrate.com/krur61mwk6?key=bc92884ecbe6757f09800b5db9e2ecc7", "_blank");

            alert('Ad will open. Please wait while we prepare your reward.');
            points += 01; 
            balance += 0.002;
            updateBalance();

            alert('Thank you for viewing the ad! You earned 1 points and $0.002.');
        }
